  ...
  const projects = [
    {
      ...
      description:
        "A data-driven web application tracking the complex economy of Path of Exile 2 with an automated ETL pipeline.",
      tech: ["Python & FastAPI", "React", "PostgreSQL", "Cron Jobs"],
      image: "/images/poe2-market.jpg", // Remember to add this image to your public folder!
      link: "https://poe-2-market-nexus.vercel.app/", // Replace with your actual Vercel URL
    },
    {
      id: "ai-assistant", // Unique ID for linking
      title: "Intelligent Portfolio Assistant",
      description:
        "A context-aware AI powered by Gemini 3 Flash to engage visitors.",
    ...
    },
    {
      ...
      description:
        "A professional reporting tool for property managers to track maintenance and incidents.",
